...
//for special symbols like BRK.B the image file name is generated by removing the dot and converting to uppercase, so BRK.B becomes BRKB_DEX_620.png
const getFileName = (symbol: string, type: 'dex' | 'gex', resolution: string) => `${symbol.replaceAll('.', '').toUpperCase()}_${type.toUpperCase()}_${resolution}.png`;
